...
--               C:/Users/kxdn/Desktop/DA_ZYNQ-master/dds_1.srcs/sources_1/ip/dds_addr_0/dds_addr_0_sim_netlist.vhdl
-- Design      : dds_addr_0
...
\addr_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(2) => \addr_reg_n_0_[14]\,
      S(1) => \addr_reg_n_0_[13]\,
      S(0) => \addr_reg_n_0_[12]\
    );
...
\addr_reg[16]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \addr_reg_n_0_[19]\,
      S(2) => \addr[16]_i_2_n_0\,
      S(1) => \addr[16]_i_3_n_0\,
      S(0) => \addr_reg_n_0_[16]\
    );
...
\addr_reg[20]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \addr_reg_n_0_[23]\,
      S(2) => \addr_reg_n_0_[22]\,
      S(1) => \addr_reg_n_0_[21]\,
      S(0) => \addr_reg_n_0_[20]\
    );
...
\addr_reg[27]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^addr_out\(3 downto 0)
    );
...
\addr_reg[30]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => p_0_in(7),
      S(2 downto 0) => \^addr_out\(6 downto 4)
    );
...
entity dds_addr_0 is
  ...
  attribute X_CORE_INFO of dds_addr_0 : entity is "dds_addr,Vivado 2019.2";
end dds_addr_0;
