...
################################################################
# This is a generated script based on design: DDSS
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set P [ create_bd_port -dir O -from 15 -to 0 -type data P ]
  ...
  connect_bd_net -net Net [get_bd_ports aclk] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins dds_compiler_1/aclk] [get_bd_pins mult_gen_0/CLK]
  ...
  connect_bd_net -net dds_compiler_1_m_axis_data_tdata [get_bd_pins dds_compiler_1/m_axis_data_tdata] [get_bd_pins mult_gen_0/B]
