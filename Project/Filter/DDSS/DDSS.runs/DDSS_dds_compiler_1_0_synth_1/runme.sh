...
HD_PWD='D:/HOMEWORK/DIGNIT/DDSS/DDSS.runs/DDSS_dds_compiler_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDSS_dds_compiler_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDSS_dds_compiler_1_0.tcl
