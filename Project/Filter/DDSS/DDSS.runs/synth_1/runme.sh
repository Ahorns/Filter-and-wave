...
HD_PWD='C:/Users/kxdn/Desktop/DDSS/DDSS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDSS_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDSS_wrapper.tcl
