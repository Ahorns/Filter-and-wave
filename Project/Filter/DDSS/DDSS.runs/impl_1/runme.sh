...
HD_PWD='C:/Users/kxdn/Desktop/DDSS/DDSS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DDSS_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DDSS_wrapper.tcl -notrace
