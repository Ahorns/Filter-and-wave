...
#
# Generated by export_simulation on Fri Jul 31 00:27:13 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './dds_addr_0.sh' script.

./dds_addr_0.sh -reset_run
...
./dds_addr_0.sh -noclean_files

For more information on the script, please type './dds_addr_0.sh -help'.
