...
HD_PWD='C:/Users/kxdn/Desktop/DA_ZYNQ-master/dds_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dds_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dds_main.tcl
