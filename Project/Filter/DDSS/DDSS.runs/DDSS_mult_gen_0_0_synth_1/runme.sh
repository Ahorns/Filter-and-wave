...
HD_PWD='D:/HOMEWORK/DIGNIT/DDSS/DDSS.runs/DDSS_mult_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDSS_mult_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDSS_mult_gen_0_0.tcl
